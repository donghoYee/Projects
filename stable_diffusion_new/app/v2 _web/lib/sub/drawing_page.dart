...
class _DrawPageState extends State<DrawPage> {
  ...
  Widget build(BuildContext context) {
    size = MediaQuery.of(context).size.width < MediaQuery.of(context).size.height?MediaQuery.of(context).size.width : MediaQuery.of(context).size.height;
    portrait = MediaQuery.of(context).size.width < MediaQuery.of(context).size.height;
  ...
  Future<XFile?> pick_image_web() async{
    //print("crossed here");
    return  await _picker.pickImage(source: ImageSource.gallery);
  }
    ...
    return await ImageCropper().cropImage(
      ...
      uiSettings: [
        ...
        WebUiSettings(
          ...
          enableZoom: true,
          //enableResize: true,
          boundary: portrait?  CroppieBoundary(width: size.toInt()-150, height: size.toInt()-150): CroppieBoundary(width: size.toInt()-270, height: size.toInt()-270),
          viewPort: portrait?  CroppieViewPort(width: size.toInt()-170, height: size.toInt()-170):CroppieViewPort(width: size.toInt()-300, height: size.toInt()-300),
